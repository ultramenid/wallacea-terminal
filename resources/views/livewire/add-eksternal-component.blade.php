<div class="">
    ...
    <div class=" border-b border-gray-300 dark:border-opacity-20 ">
        <div class="max-w-6xl mx-auto px-6  flex justify-between  py-16">
            <h1 class="sm:text-3xl text-xl text-newgray-900 dark:text-newgray-300 font-semibold ">Adding eksternal news</h1>
            <div class="z-30">
        ...
        <div class= "sm:col-span-3 col-span-12" >
            <div class="">
                <div class="w-full border border-gray-300 dark:border-opacity-20 rounded px-6 py-6 mb-6 ">
                    ...
                    <h1 class="text-2xl font-semibold  text-newbg-newgray-900 dark:text-gray-300 mt-4 mb-4">Status</h1>
                    <label class="w-full"  >
                    ...
                    @if ($isCategory)
                        <h1 class="text-2xl font-semibold  text-newbg-newgray-900 dark:text-gray-300 mb-4">Region</h1>
                        <label class="w-full"  >
        ...
        <div class="sm:col-span-9 col-span-12 " >
            ...
            <div x-show="tabs==='english'" x-cloak style="display: none !important">
                ...
                <div class="w-full border border-gray-300 dark:border-opacity-20 rounded px-6 py-6 mb-6" x-data="{count:0}">
                    ...
                    <textarea maxlength="160" x-ref="countme" x-on:keyup="count = $refs.countme.value.length"  rows="6"  wire:model.defer='descriptionEN' required class="bg-gray-100 dark:bg-newgray-700 text-newgray-700 dark:text-gray-300 rounded w-full border  py-2 px-4 focus:outline-none border-gray-300 dark:border-opacity-20" placeholder="Description. . ."></textarea>
